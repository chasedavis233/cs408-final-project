// Render a restaurant image card
export function renderImageCard(r) {
  const addPayload = encodeURIComponent(
    JSON.stringify({
      name: r.name,
      zip: r.zip || "00000",
      cuisine: r.cuisine,
  ...
  return `
    <article class="card card--image">
      ...
      <div class="content">
        ...
        <div class="inline">
          <button class="btn btn--ghost" data-add='${addPayload}'>
            Add to To Try
          </button>
          <a class="btn btn--primary" href="search.html?id=temp-${encodeURIComponent(
            r.name
          )}">
            Details
          </a>
...
export function mockSearch(zip = "83702") {
  return [
    ...
    },
    {
      ...
      zip,
      image:
        "https://images.unsplash.com/photo-1541745537413-b804de01d7be?w=800&q=80&auto=format&fit=crop",
    },
  ];
}
